// JavaScript Document
function changecity(){
 index = upload_house.sf.options.selectedIndex-1;
upload_house.city.length = city[index].length;
 for(var i = 0;i<city[index].length;i++)
  {
   var text = city[index][i].split("-");
   upload_house.city.options[i].text = text[0];
   upload_house.city.options[i].value =text[1];
  }
}
