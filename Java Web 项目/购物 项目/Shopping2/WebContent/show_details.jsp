...
<script type="text/javascript">
	function  AddIntoCart(id) {
	    ...
	    J.dialog.get({id: 'haoyue_creat',title: '加入购物车成功',width: 600,height:400, link: '<%=path%>/Servlet/CartServlet?id='+id+'&number='+num+'&action=AddIntoCart', cover:true});
	}
	...
	function BuyShopping(Buy_id) {
		var num = document.getElementById("number").value;
	    J.dialog.get({id: 'haoyue_creat',title: '购买成功',width: 600,height:400, link: '<%=path%>/Servlet/BuyServlet?Buy_id='+Buy_id+'&Buy_number='+num+'&action=BuyShopping', cover:true});
	}
	</script>
		...
		<table width="750" height="60" cellpadding="0" cellspacing="0"
			...
			<tr>
				...
				<td width="70%" valign="top">
					<table>
						...
						<tr>
							<td>购买数量: <span id="sub" onclick="sub();">-</span> <input
								type="text" id="number" name="buy_number" value="1" size="2" /> <span
					...
					<div id="cart">
						<a
							href="javascript:BuyShopping(<%=item.getId()%>)
					        "> <img src="images/buy.png"></a> <a
